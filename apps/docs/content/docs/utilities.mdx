...
description: Supporting modules that provide validation, lookup, detection, and formatting services to the fiscal module, including GTIN validation, XML standardization, CEP lookup, and state/status code mappings.
---
