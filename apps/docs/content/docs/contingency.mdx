---
title: Contingency Modes
description: When the primary SEFAZ web service is unavailable, NF-e/NFC-e can still be issued using contingency modes including SVC-AN, SVC-RS for NF-e and EPEC for NFC-e.
---
