---
title: NFC-e QR Code
description: Every NFC-e (model 65) must include a QR code for consumer verification, encoding a URL for checking invoice authenticity on the SEFAZ portal, with support for v2.00 and v3.00 formats.
---
